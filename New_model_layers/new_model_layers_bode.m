...
phase_impedance = angle(Z_E);
phase_tf = angle(V_IL);
mag_impedance = 20*log10(abs(Z_E));
mag_tf = 20*log10(abs(V_IL));

figure
subplot(2,1,1); plot(omega,mag_impedance);
subplot(2,1,2); plot(omega,phase_impedance);

figure
subplot(2,1,1); plot(omega,mag_tf);
subplot(2,1,2); plot(omega,phase_tf);
